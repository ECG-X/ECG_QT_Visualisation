...
colourVector <- NA
length(colourVector) <- 9724 #this equals to the length of ECG signal  
...
ggsave("C:/Users/alahmada/Desktop/CHI after review/Camera ready/R/QT_485_CC.png", width=32.31, height=6.14)
