...
ECG <- read_excel("C:/Users/alahmada/Desktop/CHI after review/Camera ready/R/QT_485.xlsx")
...
p  +  coord_polar() +
  ...
  geom_line(data=file2,aes(x=Time_RR, y=0), colour="#444444", lwd=0.5) + 
  labs(x ="Time (seconds)", y="mV", fill = "1/2 RR-Interval (ms)") + theme(legend.text=element_text(size=11),axis.title=element_text(size=25,face="bold"))
ggsave("C:/Users/alahmada/Desktop/CHI after review/Camera ready/R/QT_485_PC.png", width=15.61, height=12.93)
