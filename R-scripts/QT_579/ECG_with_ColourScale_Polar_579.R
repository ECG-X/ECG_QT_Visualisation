...
colourVector <- NA
length(colourVector) <- 10284 #this equals to the length of ECG signal array  
...
ggsave("C:/Users/alahmada/Desktop/CHI_study/vis/R/QT_579_PC.png", width=15.61, height=12.93)
