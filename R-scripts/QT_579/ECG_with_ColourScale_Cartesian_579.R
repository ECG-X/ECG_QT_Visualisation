...
ECG <- read_excel("C:/Users/alahmada/Desktop/CHI_study/vis/R/QT_579.xlsx")
...
colourVector <- NA
length(colourVector) <- 10284 #this equals to the length of ECG signal  

for (R in 1:length(R_peaks_time))
{ if (R_peaks_time[R] >= 600)
...
p  +  
  ...
  scale_x_continuous(minor_breaks = seq(0 , 10.2, 0.04),breaks = seq(0, 10, 0.2), lim = c(0,10.2)) + 
...
ggsave("C:/Users/alahmada/Desktop/CHI_study/vis/R/QT_579_CC.png", width=32.31, height=6.14)
