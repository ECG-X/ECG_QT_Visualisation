...
ECG <- read_excel("C:/Users/alahmada/Desktop/CHI_study/vis/R/441/QT_441.xlsx")
...
#caluclate the incresed value fo half RR-interval to draw the dashed lines
half_RR_value2 <- (df_Rpeaks_RR[6] - df_Rpeaks_RR[5] ) / 2
#covert to millisconds 
...
p  +  coord_polar() +
  ...
  geom_vline(xintercept = (df_Rpeaks_RR[2]/1000) + half_RR_value1, linetype="dashed", size=0.7) +
  geom_vline(xintercept = (df_Rpeaks_RR[3]/1000) + half_RR_value1,linetype="dashed", size=0.7) +
  ...
  scale_x_continuous(minor_breaks = seq(0 , 10, 0.04),breaks = seq(0, 9.8, 0.2), lim = c(0,10)) + 
...
ggsave("C:/Users/alahmada/Desktop/CHI_study/vis/R/QT_441_PC.png", width=15.61, height=12.93)
