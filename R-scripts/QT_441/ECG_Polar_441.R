...
write.csv(ECG_,"C:/Users/alahmada/Desktop/CHI_study/vis/R/file2.csv")
...
p  +  coord_polar() +
  ...
  ggsave("C:/Users/alahmada/Desktop/CHI_study/vis/R/QT_441_P.png", width=15.61, height=12.93)
