...
p  +  
  ...
  scale_x_continuous(minor_breaks = seq(0 , 10, 0.04),breaks = seq(0, 10, 0.2), lim = c(0,10)) + 
  ...
  ggsave("C:/Users/alahmada/Desktop/CHI_study/vis/R/QT_441_C.png", width=32.31, height=6.14)
