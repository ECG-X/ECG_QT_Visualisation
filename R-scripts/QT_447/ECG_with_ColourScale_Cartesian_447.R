...
colourVector <- NA
length(colourVector) <- 9208  #this equals to the length of ECG signal  
...
p  +  
  ...
  ggsave("C:/Users/alahmada/Desktop/CHI after review/Camera ready/R/QT_447_CC.png", width=32.31, height=6.14)
