...
ECG <- read_excel("C:/Users/alahmada/Desktop/CHI after review/Camera ready/R/QT_565.xlsx")
...
UpperColourLimitNEW <- 570
#next script is for visulising the ECG with the colour scale
colorcodesValues <- NA
length(colorcodesValues) <- 9
colorcodesValues[1] <- 255 # purple 
colorcodesValues[2] <- UpperColourLimitNEW - (40*7) #blue
colorcodesValues[3] <- UpperColourLimitNEW - (40*6) #lime
colorcodesValues[4] <- UpperColourLimitNEW - (40*5) #green
colorcodesValues[5] <- UpperColourLimitNEW - (40*4) #yellow
colorcodesValues[6] <- UpperColourLimitNEW - (40*3) #orange
colorcodesValues[7] <- UpperColourLimitNEW - (40*2) #dark orange
colorcodesValues[8] <- UpperColourLimitNEW - (40*1) #red
...
p  +  coord_polar() +
  ...
  ggsave("C:/Users/alahmada/Desktop/CHI after review/Camera ready/R/QT_565_PC.png", width=15.61, height=12.93)
