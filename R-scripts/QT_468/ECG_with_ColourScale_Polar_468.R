...
ECG <- read_excel("C:/Users/alahmada/Desktop/CHI_study/vis/R/468/QT_468.xlsx")
...
#caluclate the incresed value fo half RR0interval to draw the dashed lines
half_RR_value2 <- (df_Rpeaks_RR[5] - df_Rpeaks_RR[4] ) / 2
#covert to millisconds 
...
ggsave("C:/Users/alahmada/Desktop/CHI_study/vis/R/QT_468_PC.png", width=15.61, height=12.93)
